package com.dmm.framework.common.constant;
...
public class SystemConstant {
	 ...
	 * 1005 未定义的错误信息
	 */
	public final static String APP_RETURN_UNDEFINED_EXCEPTION_CODE ="1005";
	 ...
	 * 分隔符-(.)
	 */
	public static final String SPLIT_STR_SUFFIX = ".";
	/**
	 * 分隔符-(-)
	 */
	public static final String SPLIT_STR_MIDDLE = "-";
	/**
	 * 分隔符-(_)
	 */
	public static final String SPLIT_STR_BLOW = "_";
	/**
	 * 分隔符-(/)
	 */
	public static final String SPLIT_STR_SLASH = "/";
	/**
	 * 分隔符-(:)
	 */
	public static final String SPLIT_STR_COLON = ":";
}
