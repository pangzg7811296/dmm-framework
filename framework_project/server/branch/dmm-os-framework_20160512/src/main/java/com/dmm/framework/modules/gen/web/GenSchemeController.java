 ...
 *
 */
package com.dmm.framework.modules.gen.web;
...
import com.dmm.framework.modules.gen.service.GenSchemeService;
import com.dmm.framework.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.dmm.framework.modules");
		}
