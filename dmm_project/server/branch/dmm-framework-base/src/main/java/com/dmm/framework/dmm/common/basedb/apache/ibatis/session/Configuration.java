 ...
 */
package com.dmm.framework.dmm.common.basedb.apache.ibatis.session;
...
public class Configuration extends org.apache.ibatis.session.Configuration{
	...
	protected static class StrictMap<V> extends HashMap<String, V> {
		...
		public V put(String key, V value) {
			if (com.dmm.framework.dmm.common.basedb.apache.ibatis.thread.Runnable.isRefresh()) {
				remove(key);
				com.dmm.framework.dmm.common.basedb.apache.ibatis.thread.Runnable.log.debug("refresh key:"
